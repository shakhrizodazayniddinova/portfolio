...
const designCardData = [
    ...
    {img: albumlayout, workName: 'Album layout', aboutWork: 'React | Material UI | Responsive', link: 'https://album-layout-by-shakhrizoda.netlify.app/', githubLink: 'https://github.com/shakhrizodazayniddinova/album-layout', sourcecode: 'Source Code'},
];
...
const dynamicCardData = [
    ...
    {img: calendar, workName: 'Calendar', aboutWork: 'Webpack | SCSS | Jsx | MomentJs | React Animation Reveal | Not Responsive', link: 'https://calendar-by-shakhrizoda.netlify.app/', githubLink: 'https://github.com/shakhrizodazayniddinova/calendar', sourcecode: 'Source Code'},
];
                ...
                <Grid item xs={12} sm={6} md={4} className={`animate__animated animate__rotateInUpRight`}>
                    <Box className='workCard'>
                        <Box className='workCardImgBox'>
                            ...
                            <Typography variant='caption' className='sourceCodeText'><a href={items.githubLink} className='sourceCode'>{items.sourcecode}</a></Typography>
                        </Box>
