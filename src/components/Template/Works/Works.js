...
const dynamicCardData = [
    ...
    {img: booknest, workName: 'Book Nest', aboutWork: 'React | Router DOM | Redux | Styled components | Responsive', link: 'https://booknest-by-shakhrizoda.netlify.app/', githubLink: 'https://github.com/shakhrizodazayniddinova/BookNest', sourcecode: 'Source Code'},
