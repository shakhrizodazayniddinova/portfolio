...
export const designCardData = [
    ...
    {img: kazan, workName: 'Kazan', aboutWork: 'HTML | Tailwind CSS | Responsive', link: 'https://kazan-landing.vercel.app', githubLink: 'https://github.com/shakhrizodazayniddinova/teamify', sourcecode: 'Source Code'},
